...
/* ======================= UI: Modal (PORTAL GLOBAL) ======================= */
function Modal({ open, onClose, children, title, footer }: { open: boolean; onClose: () => void; children: React.ReactNode; title?: string; footer?: React.ReactNode }) {
